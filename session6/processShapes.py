...
for i in range(1,len(PointArray)):
    ...
    #Einzelene Punkte, Feature des Layers 
    # Auf jedem Punkt werden die Punkte verändert
    feature = ShapeOut.Add_Shape()
    feature.Add_Point(x2,y2,0)
    feature.Set_Value(0,Dist)
    feature.Set_Value(1,AccDist)
    feature.Set_Value(2,Height)
